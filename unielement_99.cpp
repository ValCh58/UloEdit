...
UniElement_99::UniElement_99(QRectF rect, int logo, QPointF point, QGraphicsItem *qgi):AndElement(rect, point, qgi)
{
    if(logo == 0x99){
       logoType = "=";
    }else if(logo == 0x66){
...
UniElement_99::~UniElement_99()
{

}

void UniElement_99::buildElement(DataGraph &dtg)
{
    QPainter qp;
    qp.begin(&drawing);
    makeUniElement(qp);
...
void UniElement_99::makeUniElement(QPainter &qp)
{
